...
<body data-theme="light">
    ...
    <div id="about" class="page">
        <h1 style="font-size: 22px; text-align: center; font-weight: 600; line-height: 1.6;">
            ...
            Whether it’s a life-saving medical specimen or a high-stakes shipment, our mission remains the same: 
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            ...
            <div class="option-box" id="p1" onclick="selectPay('Skibidi Dollar', 'p1')">🪙 Skibidi Dollar</div>
            <div class="option-box" id="p2" onclick="selectPay('Credit Card', 'p2')">💳 Credit Card</div>
            <div class="option-box" id="p3" onclick="selectPay('Cash (In Person)', 'p3')">💵 Cash (In Person)</div>
...
can be used to remix but please add credit
